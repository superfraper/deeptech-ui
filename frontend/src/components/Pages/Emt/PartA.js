...
const PartA = props => {
  ...
  const fetchFields = async () => {
    ...
    try {
      ...
      const data = await api.getSectionFields(3, 'EMT'); // Specify "EMT" token type
  ...
  const sectionConfig = {
    sectionNumber: 3,
    sectionTitle: 'Part A: Information about the issuer of the e-money token',
    sectionDescription: 'Please fill in these sections',
    nextRoute: '/emt/partB', // Route to navigate to next
  };
