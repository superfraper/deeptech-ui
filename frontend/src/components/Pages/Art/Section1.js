...
const Section1 = props => {
  ...
  const fetchFields = async () => {
    ...
    try {
      ...
      const data = await api.getSectionFields(1, 'ART'); // Specify "ART" token type
      console.log('Section1 fetched fields:', data);
  ...
  const sectionConfig = {
    sectionNumber: 1,
    sectionTitle: 'I. (Section 1) Compliance with duties of information',
    sectionDescription: 'These fields are pre populated by DSF',
    nextRoute: '/art/summery',
  };
